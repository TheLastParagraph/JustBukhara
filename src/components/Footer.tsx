...
export default function Footer() {
  return (
    <footer className="bg-[#f9f8f6] text-[#1a1a1a] overflow-hidden relative border-t border-[#1a1a1a]/10">
      <div className="px-6 sm:px-12 lg:px-20 xl:px-28 pb-10 pt-20 relative z-10 max-w-[1600px] mx-auto">
        <div className="grid gap-16 lg:grid-cols-12 border-b border-[#1a1a1a]/10 pb-20">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            ...
            <form className="flex max-w-[420px] items-center rounded-sm bg-white p-1 shadow-sm ring-1 ring-[#1a1a1a]/10 focus-within:ring-[#C37A65]/50 transition-shadow">
              <input
                type="tel"
                placeholder="Enter your phone number"
                className="min-w-0 flex-1 bg-transparent px-4 py-3 text-sm text-[#1a1a1a] placeholder-[#1a1a1a]/40 outline-none"
              />
              <button type="button" className="rounded-sm bg-[#1a1a1a] hover:bg-[#C37A65] transition-colors px-6 py-3 text-xs font-bold tracking-widest text-white uppercase">
                Subscribe
              </button>
            </form>
          </div>
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-[1fr_auto] md:items-end">
          <div className="flex flex-col">
            ...
            {/* Massive Brand Name */}
            <p className="text-[clamp(3.5rem,12vw,10rem)] font-serif leading-[0.8] tracking-tight text-[#1a1a1a]">
              Just Bukhara.
            </p>
          </div>
